...
type ProductClient interface {
	GetProduct(ctx context.Context, in *RequestProductGet, opts ...grpc.CallOption) (*ResponseProductGet, error)
}
...
func (c *productClient) GetProduct(ctx context.Context, in *RequestProductGet, opts ...grpc.CallOption) (*ResponseProductGet, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResponseProductGet)
...
type ProductServer interface {
	GetProduct(context.Context, *RequestProductGet) (*ResponseProductGet, error)
...
func (UnimplementedProductServer) GetProduct(context.Context, *RequestProductGet) (*ResponseProductGet, error) {
...
func _Product_GetProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServer).GetProduct(ctx, req.(*RequestProductGet))
	}
